...
public final class profile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                       <br><form name=\"myform\" method=\"post\" action=\"userdetailupdate\" onsubmit=\"return checkWholeForm(this);\">\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("                  ");
       ...
       Statement pst=cn.createStatement();
                String q1="select * from users where UNAME='Anuj'";
            
               ResultSet rs=pst.executeQuery(q1);
              
                                    
         out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face='calibri'> UserName <font color='red'> * </font> : &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type ='text' name='username' required style='border:1px solid #000000;' value='"+ rs.getString(1) +"'/><br><br>");
         pst.close();
         cn.close();
